...
const pageTranslations: Record<string, Record<SiteLanguage, string>> = {
  ...
  , 'Sobre': { 'pt-BR': 'Sobre', es: 'Sobre', 'en-US': 'About' }
  , 'Como funciona': { 'pt-BR': 'Como funciona', es: 'Cómo funciona', 'en-US': 'How it works' }
  , 'Ver catálogo': { 'pt-BR': 'Ver catálogo', es: 'Ver catálogo', 'en-US': 'View catalog' }
  , 'Produtos digitais, licenças e automações': { 'pt-BR': 'Produtos digitais, licenças e automações', es: 'Productos digitales, licencias y automatizaciones', 'en-US': 'Digital products, licenses and automations' }
  , 'Sistemas que trabalham': { 'pt-BR': 'Sistemas que trabalham', es: 'Sistemas que trabajan', 'en-US': 'Systems that work' }
  , 'enquanto você cresce.': { 'pt-BR': 'enquanto você cresce.', es: 'mientras tú creces.', 'en-US': 'while you grow.' }
  , 'ERPs, landing pages e automações prontos para o seu negócio. Você escolhe, paga como preferir e recebe o acesso direto no seu painel.': { 'pt-BR': 'ERPs, landing pages e automações prontos para o seu negócio. Você escolhe, paga como preferir e recebe o acesso direto no seu painel.', es: 'ERPs, landing pages y automatizaciones listos para tu negocio. Eliges, pagas como prefieras y recibes el acceso directamente en tu panel.', 'en-US': 'ERPs, landing pages and automations ready for your business. You choose, pay however you like and get access right in your dashboard.' }
  , 'Falar comigo': { 'pt-BR': 'Falar comigo', es: 'Hablar conmigo', 'en-US': 'Talk to me' }
  , 'Pix, boleto e cartão': { 'pt-BR': 'Pix, boleto e cartão', es: 'Pix, boleto y tarjeta', 'en-US': 'Pix, boleto and card' }
  , 'Suporte direto com o desenvolvedor': { 'pt-BR': 'Suporte direto com o desenvolvedor', es: 'Soporte directo con el desarrollador', 'en-US': 'Direct support from the developer' }
  , 'O que eu crio': { 'pt-BR': 'O que eu crio', es: 'Lo que creo', 'en-US': 'What I build' }
  , 'Ferramentas digitais feitas para rodar de verdade.': { 'pt-BR': 'Ferramentas digitais feitas para rodar de verdade.', es: 'Herramientas digitales hechas para funcionar de verdad.', 'en-US': 'Digital tools built to actually run.' }
  , 'Cada produto nasce de um problema real de negócio e chega pronto para uso, com licença e atualizações.': { 'pt-BR': 'Cada produto nasce de um problema real de negócio e chega pronto para uso, com licença e atualizações.', es: 'Cada producto nace de un problema real de negocio y llega listo para usar, con licencia y actualizaciones.', 'en-US': 'Every product starts from a real business problem and arrives ready to use, with a license and updates.' }
  , 'Estoque, vendas e financeiro num só lugar, acessível do computador ou do celular.': { 'pt-BR': 'Estoque, vendas e financeiro num só lugar, acessível do computador ou do celular.', es: 'Inventario, ventas y finanzas en un solo lugar, accesible desde la computadora o el celular.', 'en-US': 'Inventory, sales and finance in one place, available on your computer or phone.' }
  , 'Páginas rápidas e responsivas, pensadas para transformar visita em cliente.': { 'pt-BR': 'Páginas rápidas e responsivas, pensadas para transformar visita em cliente.', es: 'Páginas rápidas y responsivas, pensadas para convertir visitas en clientes.', 'en-US': 'Fast, responsive pages designed to turn visitors into customers.' }
  , 'Automações': { 'pt-BR': 'Automações', es: 'Automatizaciones', 'en-US': 'Automations' }
  , 'Tarefas repetitivas rodando sozinhas, para você focar no que importa.': { 'pt-BR': 'Tarefas repetitivas rodando sozinhas, para você focar no que importa.', es: 'Tareas repetitivas funcionando solas, para que te enfoques en lo importante.', 'en-US': 'Repetitive tasks running on their own, so you can focus on what matters.' }
  , 'Licenças': { 'pt-BR': 'Licenças', es: 'Licencias', 'en-US': 'Licenses' }
  , 'Acesso liberado no seu painel, com chave de ativação e atualizações.': { 'pt-BR': 'Acesso liberado no seu painel, com chave de ativação e atualizações.', es: 'Acceso liberado en tu panel, con clave de activación y actualizaciones.', 'en-US': 'Access unlocked in your dashboard, with an activation key and updates.' }
  , 'Do clique ao acesso em três passos.': { 'pt-BR': 'Do clique ao acesso em três passos.', es: 'Del clic al acceso en tres pasos.', 'en-US': 'From click to access in three steps.' }
  , 'Escolha o produto': { 'pt-BR': 'Escolha o produto', es: 'Elige el producto', 'en-US': 'Choose the product' }
  , 'Veja o catálogo e abra os detalhes de cada solução antes de decidir.': { 'pt-BR': 'Veja o catálogo e abra os detalhes de cada solução antes de decidir.', es: 'Mira el catálogo y abre los detalles de cada solución antes de decidir.', 'en-US': 'Browse the catalog and open each solution’s details before you decide.' }
  , 'Pague como preferir': { 'pt-BR': 'Pague como preferir', es: 'Paga como prefieras', 'en-US': 'Pay however you like' }
  , 'Pix, boleto ou cartão em reais. Clientes do exterior pagam no cartão internacional.': { 'pt-BR': 'Pix, boleto ou cartão em reais. Clientes do exterior pagam no cartão internacional.', es: 'Pix, boleto o tarjeta en reales. Los clientes del exterior pagan con tarjeta internacional.', 'en-US': 'Pix, boleto or card in reais. International customers pay by international card.' }
  , 'Receba o acesso no painel': { 'pt-BR': 'Receba o acesso no painel', es: 'Recibe el acceso en el panel', 'en-US': 'Get access in your dashboard' }
  , 'Assim que o pagamento é confirmado, a licença aparece na sua área de cliente.': { 'pt-BR': 'Assim que o pagamento é confirmado, a licença aparece na sua área de cliente.', es: 'En cuanto se confirma el pago, la licencia aparece en tu área de cliente.', 'en-US': 'As soon as payment is confirmed, the license appears in your customer area.' }
  , 'Formas de pagamento:': { 'pt-BR': 'Formas de pagamento:', es: 'Formas de pago:', 'en-US': 'Payment methods:' }
  , 'Boleto': { 'pt-BR': 'Boleto', es: 'Boleto', 'en-US': 'Boleto' }
  , 'Cartão': { 'pt-BR': 'Cartão', es: 'Tarjeta', 'en-US': 'Card' }
  , 'Escolha e comece hoje.': { 'pt-BR': 'Escolha e comece hoje.', es: 'Elige y empieza hoy.', 'en-US': 'Choose and start today.' }
  , 'Novas soluções chegando em breve. Fale com a gente para um projeto sob medida.': { 'pt-BR': 'Novas soluções chegando em breve. Fale com a gente para um projeto sob medida.', es: 'Nuevas soluciones muy pronto. Habla con nosotros para un proyecto a medida.', 'en-US': 'New solutions coming soon. Talk to us about a custom project.' }
  , 'Nenhuma solução nesta categoria por enquanto.': { 'pt-BR': 'Nenhuma solução nesta categoria por enquanto.', es: 'Todavía no hay soluciones en esta categoría.', 'en-US': 'No solutions in this category yet.' }
  , 'Quem está por trás': { 'pt-BR': 'Quem está por trás', es: 'Quién está detrás', 'en-US': 'Who’s behind it' }
  , 'Oi, eu sou o Kelven.': { 'pt-BR': 'Oi, eu sou o Kelven.', es: 'Hola, soy Kelven.', 'en-US': 'Hi, I’m Kelven.' }
  , 'Sou o desenvolvedor por trás do Kelven Studio. Crio os sistemas, automações e páginas do catálogo e atendo você diretamente, do primeiro contato ao suporte depois da compra.': { 'pt-BR': 'Sou o desenvolvedor por trás do Kelven Studio. Crio os sistemas, automações e páginas do catálogo e atendo você diretamente, do primeiro contato ao suporte depois da compra.', es: 'Soy el desarrollador detrás de Kelven Studio. Creo los sistemas, automatizaciones y páginas del catálogo y te atiendo directamente, desde el primer contacto hasta el soporte después de la compra.', 'en-US': 'I’m the developer behind Kelven Studio. I build the systems, automations and pages in the catalog and help you directly, from the first contact to support after your purchase.' }
  , 'Pronto para automatizar o seu negócio?': { 'pt-BR': 'Pronto para automatizar o seu negócio?', es: '¿Listo para automatizar tu negocio?', 'en-US': 'Ready to automate your business?' }
  , 'Receba novidades e lançamentos do catálogo por e-mail.': { 'pt-BR': 'Receba novidades e lançamentos do catálogo por e-mail.', es: 'Recibe novedades y lanzamientos del catálogo por correo.', 'en-US': 'Get catalog news and launches by email.' }
  , 'Recebemos seu contato. Em breve você recebe novidades e lançamentos.': { 'pt-BR': 'Recebemos seu contato. Em breve você recebe novidades e lançamentos.', es: 'Recibimos tu contacto. Pronto recibirás novedades y lanzamientos.', 'en-US': 'We got your details. You’ll receive news and launches soon.' }
  , 'Enviando...': { 'pt-BR': 'Enviando...', es: 'Enviando...', 'en-US': 'Sending...' }
  , 'Ao enviar, você concorda com a': { 'pt-BR': 'Ao enviar, você concorda com a', es: 'Al enviar, aceptas la', 'en-US': 'By submitting, you agree to the' }
  , 'política de privacidade': { 'pt-BR': 'política de privacidade', es: 'política de privacidad', 'en-US': 'privacy policy' }
  , 'Mascote do Kelven Studio: um lobo-guará de óculos escuros segurando um tablet': { 'pt-BR': 'Mascote do Kelven Studio: um lobo-guará de óculos escuros segurando um tablet', es: 'Mascota de Kelven Studio: un aguará guazú con gafas de sol sosteniendo una tableta', 'en-US': 'Kelven Studio mascot: a maned wolf in sunglasses holding a tablet' }
  , 'Vídeo do mascote do Kelven Studio escolhendo e comprando um produto no tablet': { 'pt-BR': 'Vídeo do mascote do Kelven Studio escolhendo e comprando um produto no tablet', es: 'Video de la mascota de Kelven Studio eligiendo y comprando un producto en la tableta', 'en-US': 'Video of the Kelven Studio mascot choosing and buying a product on a tablet' }
  , 'Kelven Sousa, criador do Kelven Studio': { 'pt-BR': 'Kelven Sousa, criador do Kelven Studio', es: 'Kelven Sousa, creador de Kelven Studio', 'en-US': 'Kelven Sousa, creator of Kelven Studio' }
};
