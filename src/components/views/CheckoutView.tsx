...
import { formatPrice, type CatalogProduct } from '@/lib/products';
...
function CheckoutContent({ products }: { products: CatalogProduct[] }) {
...
export default function CheckoutView({ products }: { products: CatalogProduct[] }) {
  return (
    <PublicShell>
